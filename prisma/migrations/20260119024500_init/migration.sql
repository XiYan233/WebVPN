...
CREATE TABLE `Client` (
    ...
    `basePath` VARCHAR(191) NOT NULL DEFAULT '/',
...
-- AddForeignKey
ALTER TABLE `ClientKey` ADD CONSTRAINT `ClientKey_clientId_fkey` FOREIGN KEY (`clientId`) REFERENCES `Client`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
